    ...
    {/* begin orig code */}
      ...
      {/* terms  */}
       ...
       {/* navigation warning  */}
        {/*<NavWarning />*/}
       <div
          className="mx-auto mt-2 flex animate-fade-up items-center justify-center space-x-2 opacity-0"
          style={{ animationDelay: "0.25s", animationFillMode: "forwards" }}
      >
        ...
        <p className="font-display text-xxxsm text-white">Please note that while you chat with us you must remain on the app.<br></br>If you navigate away from the chat window your connection may be lost.</p>        
       </div>
      </div>
      <Footer/>
  </ReCaptchaProvider>
