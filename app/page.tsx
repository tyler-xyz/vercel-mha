...
import LetsChat from "@/components/home/xchat-button";
    ...
    <>
      <ReCaptchaProvider reCaptchaKey="6Lc2qS4oAAAAACIcdUjUVeeviZGRFaLVvN_aIUL1">
        ...
        <div className="z-10 w-full max-w-xl px-5 xl:px-0">
          ...
          >
            <Balancer>We can relate.</Balancer>
          </h3>
          ...
          <p
            ...
            style={{ animationDelay: "0.25s", animationFillMode: "forwards" }}
          >
            <Balancer><strong>Monday through Friday</strong></Balancer>
            <br />
            <Balancer>from 2pm to 8pm EST</Balancer>
          </p>
          ...
          <div
            ...
            style={{ animationDelay: "0.25s", animationFillMode: "forwards" }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="stroke-white shrink-0 w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>

            <p className="font-display text-xxxsm text-white text-center">
              Please note that while you chat with us you must remain on the app.
              <br />
              If you navigate away from the chat window your connection may be lost.
            </p>
          </div>
        </div>
