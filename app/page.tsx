  ...
  <ReCaptchaProvider reCaptchaKey="6Lc2qS4oAAAAACIcdUjUVeeviZGRFaLVvN_aIUL1">
    {/* begin orig code */}
      ...
      >
        ...
        <p className="md:text-xxsm font-display text-white style={{ fontSize: '10px' }}">Please note that while you chat with us you must remain on the app.<br></br>If you navigate away from the chat window your connection may be lost.</p>        
       </div>
      </div>
      <Footer/>
  </ReCaptchaProvider>
