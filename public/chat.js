...
Twilio.FlexWebChat.createWebChat(appConfig).then(webchat => {
   ...
   // Twilio.FlexWebChat.MessagingCanvas.defaultProps.predefinedMessage.body = "It may take a moment to assign you a peer advocate. We appreciate your patience.";
    Twilio.FlexWebChat.MessagingCanvas.defaultProps.predefinedMessage.body = "Thank you for texting into the Trusted Chat Line, a Youth Peer Advocate will be with you shortly. But first, How are you doing today?";
